...
document.querySelector("#start").innerHTML = numbers;

function resultNums() {
  sortNums(numbers);
  document.querySelector("#result").innerHTML = numbers;  
}

document.querySelector("button").addEventListener("click", resultNums);